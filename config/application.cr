...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Argus web application."
  #
  #
  ...
  #
  # settings.secret_key_base= HrTSIG3oq0YvyMsF0AP79bFI53VvAWXoMoEnpS4j6mo
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("argus.log", "w"))
  #
  #
end
